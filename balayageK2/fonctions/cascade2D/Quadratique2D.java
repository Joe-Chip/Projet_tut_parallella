...
public class Quadratique2D extends CalculCascade2D  {

	public Quadratique2D(Hashtable<String, Object> initialisation) {
	...
	public Quadratique2D(BufferedReader br) {
		this();
		try {
			readParam(br);
...
*/
	public void calculM() {
		...
		if (lstChoixPlanSelectedIndex==0)
			valMnouveau =  valM2 * valM2  + b * valM1 + a; // A
		else 
			valMnouveau =  valM2 * valM2  + a * valM1 + b; 
