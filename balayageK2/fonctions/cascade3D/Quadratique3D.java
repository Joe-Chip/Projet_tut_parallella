...
public class Quadratique3D extends Cubique3D  {

	public Quadratique3D(Hashtable<String, Object> initialisation) {
	...
	public Quadratique3D(BufferedReader br) {
		this();
		try {
			readParam(br);
