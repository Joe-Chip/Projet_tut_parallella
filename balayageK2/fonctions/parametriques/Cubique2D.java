...
public class Cubique2D extends CalculParametriques {
	...
	public Cubique2D() {
		...
		titre = new JLabel("paramétrique - Cubique 2d", JLabel.CENTER);
	}
	...
	public void calculM() {
		double valM1 = lgN[indiceItérationCourante][m-1];
		double valM2 = lgN[indiceItérationPrécédente][m-1];
