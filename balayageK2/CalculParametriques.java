...
public abstract class CalculParametriques extends CalculBase {
	...
	public int nombreLignes = 16; // il faut nombreLignes<cycleMax+2 et nbrlignes soit une puissance de 2 !
...
*/
	...
	public void calcul() {
		...
		if (ordreCycle>0) {
			if (panelDessinDistant==null) panelDessin.ajouterPoint(a, b, new ListeCouleurs(panelCouleurs.listeCouleursPréférées[ordreCycle-1]));
			...
			if (panelDessinDistant==null) panelDessin.ajouterPoint(a, b, new ListeCouleurs(Color.yellow));
